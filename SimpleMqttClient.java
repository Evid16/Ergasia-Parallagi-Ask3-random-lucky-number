	...
	public void runClient(){
		...
		if (publisher){
			while (true){
					...
					String rand = String.format("%d", number.nextInt(101));
					String pubMsg = "{\"Your Lucky Number is \":" + rand + "}";
					int pubQoS = 0;
					...
					// Publish the message
					log.info("Publishing to topic \"" + topic + "\" qos " + pubQoS + "\" value " + rand);
